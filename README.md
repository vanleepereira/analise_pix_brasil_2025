...
> **[Acesse o Dashboard Online aqui](https://app.powerbi.com/view?r=eyJrIjoiYTRmMjliOTYtOGE3My00ZDJkLWE4ODYtNTU4Nzg4ZGUzMzRjIiwidCI6IjY2OWExOTdhLTA5NTQtNDdmZC1hN2IwLTkxMDEyNDZlN2YwZCJ9)**
...
1.  **Extração e ETL (Python):** Tratamento dos dados brutos em formato JSON extraídos do portal de Dados Abertos do Banco Central.
2.  **Modelagem de Dados:** Estruturação em *Star Schema* para otimização de performance e filtros dinâmicos.
3.  **Visualização (Power BI):** Criação de um dashboard interativo para análise de KPIs, volumetria e tendências sazonais.
...
* `PIX.mp4`: Vídeo demonstrativo da interatividade do dashboard.
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/van-lee-pereira-90077b40/)
